...
namespace SilksongRandomizer
{
    public class LocationSet
    {
            ...
            CoreLocationManifest.AppendTo(new Location[]
        {
            ...
            // Fleas
            new Location("Save Flea: The Marrow (Tangle)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Bone_06) { RandomizerPlugin.Instance.ShowFleaMessage("Tangle"); return true; } return false; }),
            new Location("Save Flea: Deep Docks Bellway (Eepy)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Dock_16) { RandomizerPlugin.Instance.ShowFleaMessage("Eepy");  return true;} return false; }),
            new Location("Save Flea: Deep Docks Weaver Burial Spire (Squeesh)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Bone_East_05) { RandomizerPlugin.Instance.ShowFleaMessage("Squeesh"); return true; } return false; }),
            new Location("Save Flea: Far Fields Captured (Thoughtless)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Bone_East_17b) { RandomizerPlugin.Instance.ShowFleaMessage("Thoughtless"); return true; } return false; }),
            new Location("Save Flea: Hunter's March (Yapper)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Ant_03) { RandomizerPlugin.Instance.ShowFleaMessage("Yapper"); return true;} return false; }),
            new Location("Save Flea: Greymoor Craw Lake (Gwah)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Greymoor_15b) { RandomizerPlugin.Instance.ShowFleaMessage("Gwah"); return true; } return false; }),
            new Location("Save Flea: Greymoor Tower (Snoozles)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Greymoor_06) { RandomizerPlugin.Instance.ShowFleaMessage("Snoozles"); return true; } return false; }),
            new Location("Save Flea: Shellwood (Shelly)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Shellwood_03) { RandomizerPlugin.Instance.ShowFleaMessage("Shelly"); return true; } return false; }),
            new Location("Save Flea: Pilgrim's Rest (Sleeby)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Bone_East_10_Church) { RandomizerPlugin.Instance.ShowFleaMessage("Sleeby");  return true; } return false; }),
            new Location("Save Flea: Blasted Steps (Nini)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Coral_35) { RandomizerPlugin.Instance.ShowFleaMessage("Nini"); return true; } return false; }),
            new Location("Save Flea: Sinner's Road (Stelf)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Dust_12) { RandomizerPlugin.Instance.ShowFleaMessage("Stelf"); return true; } return false; }),
            new Location("Save Flea: Exhaust Organ (Rangle)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Dust_09) { RandomizerPlugin.Instance.ShowFleaMessage("Rangle"); return true; } return false; }),
            new Location("Save Flea: Bellhart (Bellphy)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Belltown_04) { RandomizerPlugin.Instance.ShowFleaMessage("Bellphy"); return true; } return false; }),
            new Location("Save Flea: Wormways (Snacc)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Crawl_06) { RandomizerPlugin.Instance.ShowFleaMessage("Snacc"); return true; } return false; }),
            new Location("Save Flea: The Slab Cell (Sway)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Slab_Cell) { RandomizerPlugin.Instance.ShowFleaMessage("Sway"); return true; } return false; }),
            new Location("Save Flea: Bilewater Thieves (Cower)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Shadow_28) { RandomizerPlugin.Instance.ShowFleaMessage("Cower"); return true; } return false; }),
            new Location("Save Flea: Deep Docks Mines (Le Bomba)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Dock_03d) { RandomizerPlugin.Instance.ShowFleaMessage("Le Bomba"); return true; } return false; }),
            new Location("Save Flea: Wisp Thicket (Fidget)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Under_23) { RandomizerPlugin.Instance.ShowFleaMessage("Fidget"); return true; } return false; }),
            new Location("Save Flea: Bilehaven (Spangle)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Shadow_10) { RandomizerPlugin.Instance.ShowFleaMessage("Spangle"); return true; } return false; }),
            new Location("Save Flea: Choral Cambers Spa (Oowa)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Song_14) { RandomizerPlugin.Instance.ShowFleaMessage("Oowa"); return true; } return false; }),
            new Location("Save Flea: Sands of Karak (Crustly)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Coral_24) { RandomizerPlugin.Instance.ShowFleaMessage("Crustly"); return true; } return false; }),
            new Location("Save Flea: Mount Fay (Ice Cube)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Peak_05c) { RandomizerPlugin.Instance.ShowFleaMessage("Ice Cube"); return true; } return false; }),
            new Location("Save Flea: Songclave (Groggy)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Library_09) { RandomizerPlugin.Instance.ShowFleaMessage("Groggy"); return true; } return false; }),
            new Location("Save Flea: Choral Cambers Walled (Mimi)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Song_11) { RandomizerPlugin.Instance.ShowFleaMessage("Mimi"); return true; } return false; }),
            new Location("Save Flea: Whispering Vaults (Birdy)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Library_01) { RandomizerPlugin.Instance.ShowFleaMessage("Birdy"); return true; } return false; }),
            new Location("Save Flea: Underworks (Boomy)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Under_21) { RandomizerPlugin.Instance.ShowFleaMessage("Boomy"); return true; } return false; }),
            new Location("Save Flea: The Slab Bellway (Honk Shoo)", ItemType.Flea, () => { if (PlayerData.instance.SavedFlea_Slab_06) { RandomizerPlugin.Instance.ShowFleaMessage("Honk Shoo"); return true; } return false; }),
