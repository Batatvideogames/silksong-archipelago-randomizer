...
namespace SilksongRandomizer
{
    internal static class MinorPickupManifest
    {
        ...
        {
            new Entry("Frayed Rosary String: Putrified Ducts", "aqueduct_01", "Rosary_Set_Frayed", 256.19f, 14.67f),
            new Entry("Rosary Necklace: Fleatopia", "aqueduct_05_festival", "Rosary_Set_Medium", 152.783f, 16.2396f),
            new Entry("Rosary String: Fleatopia", "aqueduct_05_festival", "Rosary_Set_Small", 154.043f, 15.9796f),
            new Entry("Shard Bundle: Memorium", "arborium_11", "Shard Pouch", 211.22f, 10.27f),
            new Entry("Frayed Rosary String: The Marrow (Flea Caravan Passage)", "bone_10", "Rosary_Set_Frayed", 98.9849f, 41.3206f),
            new Entry("Frayed Rosary String: Deep Docks", "bone_east_04b", "Rosary_Set_Frayed", 6.462f, 87.1857f),
            new Entry("Rosary String: Far Fields", "bone_east_14", "Rosary_Set_Small", 13.82f, 7.461f),
            new Entry("Pristine Core: Cogwork Core", "cog_07", "Pristine Core", 0f, 0f, "Battle Scene Test/Battle Scene/Wave 2 - Item/Item Placer/Collectable Item Pickup"),
            new Entry("Shard Bundle: Cogwork Core", "cog_10", "Shard Pouch", 6.78f, 44.67f),
            new Entry("Frayed Rosary String: Blasted Steps", "coral_03", "Rosary_Set_Frayed", 38.64f, 5.53f),
            new Entry("Beast Shard: Blasted Steps", "coral_36", "Great Shard", 20.0542f, 48.5738f),
            new Entry("Frayed Rosary String: Wormways", "crawl_02", "Rosary_Set_Frayed", 3.14f, 142.3655f),
            new Entry("Shard Bundle: Deep Docks #1", "dock_02", "Shard Pouch", 38.79f, 3.5175f),
            new Entry("Beast Shard: Deep Docks", "dock_11", "Great Shard", 100.63f, 6.28f),
            new Entry("Frayed Rosary String: Sinner's Road", "dust_01", "Rosary_Set_Frayed", 76.43f, 2.7178f),
            new Entry("Shard Bundle: Sinner's Road", "dust_06", "Shard Pouch", 26.11f, 96.25f),
            new Entry("Shard Bundle: Greymoor #1", "greymoor_05", "Shard Pouch", 59.01f, 62.74f),
            new Entry("Shard Bundle: Greymoor #2", "greymoor_12", "Shard Pouch", 61.29f, 14.4f),
            new Entry("Frayed Rosary String: Greymoor #1", "greymoor_15", "Rosary_Set_Frayed", 64.41f, 24.21f),
            new Entry("Frayed Rosary String: Greymoor #2", "greymoor_15b", "Rosary_Set_Frayed", 91.86f, 35.26f),
            new Entry("Pale Rosary Necklace: High Halls", "hang_06_bank", "Rosary_Set_Huge_White", 73.41f, 35.3895f),
            new Entry("Frayed Rosary String: High Halls", "hang_16", "Rosary_Set_Frayed", 68.15f, 6.38f),
            new Entry("Heavy Rosary Necklace: Whispering Vaults", "library_02", "Rosary_Set_Large", 76.437f, 48.02f),
            new Entry("Heavy Rosary Necklace: Songclave", "library_09", "Rosary_Set_Large", 14.08f, 36.42f),
            new Entry("Shard Bundle: Whispering Vaults", "library_12", "Shard Pouch", 126.39f, 24.4143f),
            new Entry("Frayed Rosary String: Bone Bottom (Silkspear Passage)", "mosstown_02", "Rosary_Set_Frayed", 35.32f, 40.27f),
            new Entry("Shard Bundle: Deep Docks #2", "room_forge", "Shard Pouch", 5.08f, 37.38f),
            new Entry("Frayed Rosary String: Bilewater", "shadow_02", "Rosary_Set_Frayed", 49.21f, 161.48f),
            new Entry("Frayed Rosary String: Shellwood", "shellwood_01", "Rosary_Set_Frayed", 48.99f, 23.27f),
            new Entry("Rosary String: Shellwood #1", "shellwood_01b", "Rosary_Set_Small", 33.13f, 72.38f),
            new Entry("Shard Bundle: Shellwood", "shellwood_13", "Shard Pouch", 82.2928f, 67.2101f),
            new Entry("Rosary String: Shellwood #2", "shellwood_25", "Rosary_Set_Small", 83.3f, 25.4172f),
            new Entry("Frayed Rosary String: The Slab #1", "slab_02", "Rosary_Set_Frayed", 53.4572f, 21.2107f),
            new Entry("Shard Bundle: The Slab", "slab_04", "Shard Pouch", 9.4863f, 15.6907f),
            new Entry("Frayed Rosary String: The Slab #2", "slab_18", "Rosary_Set_Frayed", 17.2344f, 21.2003f),
            new Entry("Frayed Rosary String: The Slab #3", "slab_22", "Rosary_Set_Frayed", 28.3f, 30.39f),
            new Entry("Heavy Rosary Necklace: Choral Chambers", "song_04", "Rosary_Set_Large", 121.49f, 37.57f),
            new Entry("Rosary Necklace: Choral Chambers #1", "song_07", "Rosary_Set_Medium", 3.83f, 4.91f),
            new Entry("Rosary Necklace: Choral Chambers #2", "song_09", "Rosary_Set_Medium", 39.38f, 8.2749f),
            new Entry("Frayed Rosary String: Moss Grotto", "tut_01", "Rosary_Set_Frayed", 43.96f, 20.43f),
            new Entry("Shard Bundle: Underworks #1", "under_03", "Shard Pouch", 4.5876f, 6.2287f),
            new Entry("Frayed Rosary String: Underworks #1", "under_07c", "Rosary_Set_Frayed", 75.57f, 76.08f),
            new Entry("Frayed Rosary String: Underworks #2", "under_12", "Rosary_Set_Frayed", 33.13f, 10.29f),
            new Entry("Pristine Core: Underworks", "under_17", "Pristine Core", 75.44f, 23.37f),
            new Entry("Shard Bundle: Underworks #2", "under_18", "Shard Pouch", 34.14f, 34.3f),
            new Entry("Rosary Necklace: Wisp Thicket", "wisp_02", "Rosary_Set_Medium", 111.32f, 37.99f),
            new Entry("Frayed Rosary String: Greymoor #3", "wisp_03", "Rosary_Set_Frayed", 62.89f, 35.37f),
